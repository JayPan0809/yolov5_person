...
class Ui_MainWindow(QtWidgets.QMainWindow):
    def __init__(self, parent=None):
        ...
        weights = '/Users/john/Desktop/毕业论文/object/yolov5/best.pt'   # 模型加载路径
        imgsz = 640  # 预测图尺寸大小
        self.conf_thres = 0.4  # NMS置信度
        self.iou_thres = 0.4  # IOU阈值
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "YOLOv5行人检测平台"))
    ...
    def button_image_open(self):
        ...
        cv2.imwrite('/Users/john/Documents', showimg)
